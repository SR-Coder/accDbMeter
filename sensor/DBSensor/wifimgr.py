        ...
        <html>
            <h1 style="color: #5e9ca0; text-align: center;">
                <span style="color: #ff0000;">
                    ACC DB Meter Wi-Fi Client Setup
                </span>
            </h1>
    ...
    client.sendall("""\
            ...
            <h5>
                <span style="color: #ff0000;">
                    ...
                    "%(filename)s" file in your Pico W module for future usage.
        ...
        response = """\
            <html>
                <center>
                    ...
                    <h1 style="color: #5e9ca0; text-align: center;">
                        <span style="color: #ff0000;">
                            DB Meter successfully connected to WiFi network %(ssid)s.
                        </span>
                    </h1>
                    <br><br>
                </center>
        ...
        response = """\
            <html>
                <center>
                    <h1 style="color: #5e9ca0; text-align: center;">
                        <span style="color: #ff0000;">
                            DB Meter could not connect to WiFi network %(ssid)s.
                        </span>
                    </h1>
                    <br><br>
                    <form>
